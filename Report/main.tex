...
\section{Attacks}
    ...
    \subsection{Image Laundering with Stable Diffusion}
        ...
        \begin{figure}[h]
            ...
            \caption{Visualization of the 2 step architecture proposed in \cite{mandelli2024synthetic} for the laundered image classification task. The first step discriminate real images from synthetic (both fully and lanudere) ones, while the second step discriminate fully synthetic images from laundered ones}
