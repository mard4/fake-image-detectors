"""
Main file to test an image through the real vs synthetic detector
...
class RealvsSyntheticDetector:
    ...
    def synth_img_detection(self, img: np.array) -> torch.Tensor:
        """
        Detection pipeline:
...
def main():
    ...
    for roba in stuff:
        ...
        device = f'cuda:{gpu}'
        detector = RealvsSyntheticDetector(device=device, M=M, select_face_test=select_face_test)
